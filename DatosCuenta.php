...
$sql=$cn->prepare("SELECT * FROM cuenta WHERE cuenta.CodigoCuenta=:Codigo"); 
...
<div style="width:500px; margin:0 auto;">
  <table width="387" height="437" border="0" cellpadding="0" cellspacing="0" style="margin-top:20px;" id="example" class="display compact">
    <thead>
      <tr>
    ...
    <tr>
      ...
      <td width="128"><span class="Estilo11"><?php echo $DatosCuenta['CodigoCuenta']?></span></td>
      <td width="8"><span class="Estilo5"></span></td>
      <td width="63"><span class="Estilo4"><a href=""><img src="Imagenes/icon18_edit_allbkg.gif" width="18" height="18" /></a><a href=""><img src="Imagenes/basura-icono-3648-48.png" width="21" height="23" /></a></span></td>
      <td width="10">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td><span class="Estilo5"></span></td>
      <td><span class="Estilo4"><a href=""><img src="Imagenes/icon18_edit_allbkg.gif" width="18" height="18" /></a><a href=""><img src="Imagenes/basura-icono-3648-48.png" width="21" height="23" /></a></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
